  ...
  render() {
    return (
      <View style={globalStyle.container}>
        ...
        <Text >주소: {this.props.review.address}</Text>
        <Text >상세주소: {this.props.review.addressDetail}</Text>
        ...
        <Text style={globalStyle.lastEditTime}>마지막 수정일: {this.props.review.timestamp}</Text>
        <ScrollView>
